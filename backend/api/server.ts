 ...
 */
app.get('/mock-downloads/:filename', (req, res) => {
  try {
    ...
    if (filename.endsWith('.pdf')) {
      ...
      doc.fontSize(12).text(`This is a mock exported file. The full implementation would dynamically generate this PDF document from the orchestrator session history.`, 100, 200, {
        width: 410,
        align: 'left'
      });
